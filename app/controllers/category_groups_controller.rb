  ...
  def create
    ...
    respond_to do |format|
      if @category_group.save
        format.html do
          redirect_to category_group_url(@category_group), notice: 'Category group was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @category_group.update(category_group_params)
        format.html do
          redirect_to category_group_url(@category_group), notice: 'Category group was successfully updated.'
        end
